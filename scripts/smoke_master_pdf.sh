...
mkdir -p "$RUN_DIR/deliverables" "$RUN_DIR/action_scope"
...
make_pdf(os.path.join(run_dir, "deliverables", "report.pdf"), pages=1)
make_pdf(os.path.join(run_dir, "deliverables", "Decision Brief - example.com - RO.pdf"), pages=1)
